  ...
  return (
    <section className="mx-auto max-w-7xl px-0 pt-2">
      <div className="relative">
        ...
        <div
          className="relative overflow-hidden rounded-[28px] bg-white/55 backdrop-blur ring-1 ring-slate-200 shadow-[0_40px_120px_-70px_rgba(15,23,42,.5)]"
        ...
        >
          ...
          >
            {slides.map((s) => (
              <div
                key={s.id}
                className="relative h-[220px] w-full shrink-0 sm:h-[320px] lg:h-[380px]"
              >
                ...
                {/* Neon blobs */}
                <div className="pointer-events-none absolute -left-20 -top-16 h-56 w-56 rounded-full bg-sky-300/25 blur-3xl" />
                <div className="pointer-events-none absolute left-1/3 -top-20 h-56 w-56 rounded-full bg-indigo-300/18 blur-3xl" />
                <div className="pointer-events-none absolute right-0 -top-16 h-56 w-56 rounded-full bg-cyan-300/18 blur-3xl" />
                ...
                <div className="relative z-10 flex h-full items-center">
                  <div className="w-full max-w-xl px-6 sm:px-10">
                    ...
                    <div className="mt-6 flex flex-wrap items-center gap-3">
                      <Link
                        href={s.ctaHref}
                        className="inline-flex items-center justify-center rounded-2xl px-5 py-3 text-sm font-extrabold text-white shadow-[0_18px_45px_-25px_rgba(2,132,199,.6)]"
                        style={{
                          background:
                      ...
                      <Link
                        href="/contacto"
                        className="inline-flex items-center justify-center rounded-2xl border border-white/60 bg-white/60 px-5 py-3 text-sm font-extrabold text-slate-800 backdrop-blur transition hover:bg-white/80"
                      >
                        Contacto
                      </Link>
                    </div>
          ...
          <button
            ...
            onClick={prev}
            aria-label="Anterior"
            className="group absolute left-3 top-1/2 z-20 -translate-y-1/2 rounded-full bg-white/70 p-3 ring-1 ring-white/60 backdrop-blur shadow-sm transition hover:bg-white/85"
          >
          ...
          <button
            ...
            className="group absolute right-3 top-1/2 z-20 -translate-y-1/2 rounded-full bg-white/70 p-3 ring-1 ring-white/60 backdrop-blur shadow-sm transition hover:bg-white/85"
          >
            <span className="block text-xl font-extrabold text-slate-800 transition group-hover:scale-105">
              ›
            </span>
...
function CatalogPanelCarousel({
  ...
  const s = slides[0] // ✅ dejamos fijo el contenido del primer slide
    ...
    () => [
      {
        ...
        subtitle: "aqui podras enoncotrar productos de calidad al mejor precio .",
      ...
      },
      {
        ...
        title: "Diseño Version 1.0",
        subtitle: "Simple y facil",
        ctaText: "Contacto",
        ctaHref: "/contacto",
        image:
          "https://images.unsplash.com/photo-1528698827591-e19ccd7bc23d?auto=format&fit=crop&w=2400&q=70",
    ...
    <div className="relative">
      ...
      <section className="mx-auto max-w-7xl px-0 pb-16 pt-16">
        <div className="text-center">
          ...
          <h2 className="mt-1 text-2xl font-extrabold text-slate-900">Productos mas vendidos</h2>
        </div>
